...
const CsvUpload = () => {
  ...
  const onSubmit = (data: any) => {
    ...
    axios.post(
      'http://localhost:8000/api/v1/upload_kanji_data', formData
    )
      .then(response => {
    ...
    <div>
      ...
      <Tabs>
        <div className="sec-title">
          <h2 className="Pacifico-Regular">Book/Exam Upload </h2>
        </div>
        <TabList>
          <Tab>Book Upload</Tab>
          <Tab>Exam  Upload</Tab>
        ...
        <TabPanel>
          <ThemeProvider theme={theme}>
            ...
            <Box className="csv-page">
              <div className="sec-title">
                <h2 className="Pacifico-Regular">Book Upload</h2>
              </div>
              <Container maxWidth="sm">
                <Box component={Paper} elevation={3}>
                  <form onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data" className='form'>
                    ...
                    {response ? <p className='complete_txt'>Data Imported Successfully</p> : null}
                  </form>
                </Box>
              </Container>
            </Box>
